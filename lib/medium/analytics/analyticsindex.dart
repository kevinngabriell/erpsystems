...
class AnalyticsMediumIndex extends StatefulWidget {
  const AnalyticsMediumIndex({super.key});

  @override
  State<AnalyticsMediumIndex> createState() => _AnalyticsMediumIndexState();
}

class _AnalyticsMediumIndexState extends State<AnalyticsMediumIndex> {
