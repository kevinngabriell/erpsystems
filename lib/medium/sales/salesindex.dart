...
class SalesMediumIndex extends StatefulWidget {
  const SalesMediumIndex({super.key});

  @override
  State<SalesMediumIndex> createState() => _SalesMediumIndexState();
}

class _SalesMediumIndexState extends State<SalesMediumIndex> {
