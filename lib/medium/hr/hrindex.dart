...
class HRMediumIndex extends StatefulWidget {
  const HRMediumIndex({super.key});

  @override
  State<HRMediumIndex> createState() => _HRMediumIndexState();
}

class _HRMediumIndexState extends State<HRMediumIndex> {
