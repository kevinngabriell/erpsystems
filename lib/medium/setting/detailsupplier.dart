...
class DetailSupplierMedium extends StatefulWidget {
  final supplierId;
  const DetailSupplierMedium(this.supplierId);

  @override
  State<DetailSupplierMedium> createState() => _DetailSupplierMediumState();
}

class _DetailSupplierMediumState extends State<DetailSupplierMedium> {
