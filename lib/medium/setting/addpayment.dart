...
class AddPaymentMedium extends StatefulWidget {
  const AddPaymentMedium({super.key});

  @override
  State<AddPaymentMedium> createState() => _AddPaymentMediumState();
}

class _AddPaymentMediumState extends State<AddPaymentMedium> {
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Text('Payment settings', style: TextStyle(fontSize: 9.sp, fontWeight: FontWeight.w600),)
                              ),
                              SizedBox(height: 10.h,),
                              SizedBox(
                              width: MediaQuery.of(context).size.width,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text('Add New Payment', style: TextStyle(fontSize: 7.sp, fontWeight: FontWeight.w600,)),
                                    ),
                                    SizedBox(height: 10.h,),
