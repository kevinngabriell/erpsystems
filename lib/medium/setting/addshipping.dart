...
class AddNewShippingMedium extends StatefulWidget {
  const AddNewShippingMedium({super.key});

  @override
  State<AddNewShippingMedium> createState() => _AddNewShippingMediumState();
}

class _AddNewShippingMediumState extends State<AddNewShippingMedium> {
  ...
  TextEditingController txtShippingName = TextEditingController();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text('Add New Shipping', style: TextStyle(fontSize: 7.sp, fontWeight: FontWeight.w600,)),
                                    ),
                                    SizedBox(height: 10.h,),
