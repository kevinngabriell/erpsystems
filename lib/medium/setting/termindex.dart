...
class TermIndexMedium extends StatefulWidget {
  const TermIndexMedium({super.key});

  @override
  State<TermIndexMedium> createState() => _TermIndexMediumState();
}

class _TermIndexMediumState extends State<TermIndexMedium> {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add Term', style: TextStyle(fontSize: 6.sp),)
                                          )
                                        ],
                                      ),
                                    ),
