...
class AddCustomerMedium extends StatefulWidget {
  const AddCustomerMedium({super.key});

  @override
  State<AddCustomerMedium> createState() => _AddCustomerMediumState();
}

class _AddCustomerMediumState extends State<AddCustomerMedium> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text('Add New Customer', style: TextStyle(fontSize: 7.sp, fontWeight: FontWeight.w600,)),
                                    ),
                                    SizedBox(height: 10.h,),
