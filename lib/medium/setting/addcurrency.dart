...
class AddCurrencyMedium extends StatefulWidget {
  const AddCurrencyMedium({super.key});

  @override
  State<AddCurrencyMedium> createState() => _AddCurrencyMediumState();
}

class _AddCurrencyMediumState extends State<AddCurrencyMedium> {
