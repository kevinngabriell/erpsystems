...
class CurrencyIndexMedium extends StatefulWidget {
  const CurrencyIndexMedium({super.key});

  @override
  State<CurrencyIndexMedium> createState() => _CurrencyIndexMediumState();
}

class _CurrencyIndexMediumState extends State<CurrencyIndexMedium> {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add New Currency', style: TextStyle(fontSize: 6.sp),)
                                          )
                                        ],
                                      ),
                                    ),
