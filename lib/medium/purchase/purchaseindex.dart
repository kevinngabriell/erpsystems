...
class PurchaseMediumIndex extends StatefulWidget {
  const PurchaseMediumIndex({super.key});

  @override
  State<PurchaseMediumIndex> createState() => _PurchaseMediumIndexState();
}

class _PurchaseMediumIndexState extends State<PurchaseMediumIndex> {
