...
class FinanceMediumIndex extends StatefulWidget {
  const FinanceMediumIndex({super.key});

  @override
  State<FinanceMediumIndex> createState() => _FinanceMediumIndexState();
}

class _FinanceMediumIndexState extends State<FinanceMediumIndex> {
