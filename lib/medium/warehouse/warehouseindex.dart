...
class WarehouseMediumIndex extends StatefulWidget {
  const WarehouseMediumIndex({super.key});

  @override
  State<WarehouseMediumIndex> createState() => _WarehouseMediumIndexState();
}

class _WarehouseMediumIndexState extends State<WarehouseMediumIndex> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 10.w,
                              alignment: Alignment.centerLeft,
                              child: Image.asset('Icon/WarehouseActive.png'),
                            ),
                            SizedBox(width: 3.w),
