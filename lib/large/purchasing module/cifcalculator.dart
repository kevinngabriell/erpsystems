...
class CIFCalculatorLarge extends StatefulWidget {
  const CIFCalculatorLarge({super.key});

  @override
  State<CIFCalculatorLarge> createState() => _CIFCalculatorLargeState();
}

class _CIFCalculatorLargeState extends State<CIFCalculatorLarge> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text('CIF Calculator', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600),),
                                      ),
                                    ]
                                  )
                                ),
