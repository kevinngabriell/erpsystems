                                        ...
                                        ElevatedButton(
                                          onPressed: (){
                                            setState(() {
                                              isLoading = true;
                                              if(txtPONumber.text != ''){
                                                SearchPOLocalListbyNumber = searchLocalAllParams(selectedMonth, selectedYear, txtPONumber.text);
                                                isLoading = false;
                                              } else if (txtPONumber.text == ''){
                                                SearchPOLocalListbyNumber = searchLocalByDate(selectedMonth, selectedYear);
                                                isLoading = false;
                                              }
                                              isSearch = true;
                                            });
                              ...
                              if(isSearch == true)
                                SizedBox(
                                  ...
                                  child: FutureBuilder<List<Map<String, dynamic>>>(
                                    future: SearchPOLocalListbyNumber,
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        ...
                                        return Container(
                                          child: Center(
                                            child: Text('Data is not found, please check again your month, year, and PO Number !!!')
                                          ),
                                        );
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    ElevatedButton(
                                                      ...
                                                      child: Text(statusPO, style: TextStyle(fontSize: 4.sp))
                                                    )
                                                  ],
                                                ),
                                              )
