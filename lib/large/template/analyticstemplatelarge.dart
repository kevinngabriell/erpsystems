...
class AnalyticsTemplateLarge extends StatefulWidget {
  const AnalyticsTemplateLarge({super.key});

  @override
  State<AnalyticsTemplateLarge> createState() => _AnalyticsTemplateLargeState();
}

class _AnalyticsTemplateLargeState extends State<AnalyticsTemplateLarge> {
  @override
                      ...
                      ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              alignment: Alignment.centerLeft,
                              child: Image.asset('Icon/AnalyticsActive.png'),
                            ),
                            SizedBox(width: 3.w),
