...
class PackagingSettingLarge extends StatefulWidget {
  const PackagingSettingLarge({super.key});

  @override
  State<PackagingSettingLarge> createState() => _PackagingSettingLargeState();
}

class _PackagingSettingLargeState extends State<PackagingSettingLarge> {
                        ...
                        child: Column(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Text('Packaging settings', style: TextStyle(fontSize: 6.sp, fontWeight: FontWeight.w600),)
                            ),
                            SizedBox(height: 10.h,),
                            SizedBox(
                              width: MediaQuery.of(context).size.width,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Packaging', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600,)),
                                          ElevatedButton(
                                            onPressed: (){
                                            ...
                                            child: Text('Add New Packaging', style: TextStyle(fontSize: 4.sp),)
                                          )
                                        ],
                                      ),
                                    ),
