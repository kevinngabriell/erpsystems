...
import 'package:erpsystems/large/setting%20module/addneworigin.dart';
...
class OriginSettingLarge extends StatefulWidget {
  const OriginSettingLarge({super.key});

  @override
  State<OriginSettingLarge> createState() => _OriginSettingLargeState();
}
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add New Origin', style: TextStyle(fontSize: 4.sp),)
                                          )
                                        ],
                                      ),
                                    ),
