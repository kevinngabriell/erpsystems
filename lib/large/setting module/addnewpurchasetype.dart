...
class AddNewPurchaseTypeLarge extends StatefulWidget {
  const AddNewPurchaseTypeLarge({super.key});

  @override
  State<AddNewPurchaseTypeLarge> createState() => _AddNewPurchaseTypeLargeState();
}

class _AddNewPurchaseTypeLargeState extends State<AddNewPurchaseTypeLarge> {
  TextEditingController txtSearchText = TextEditingController();
  final storage = GetStorage();
  String profileName = '';
  String companyName = '';

  TextEditingController txtPurchaseType = TextEditingController();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text('Add New Purchase Type', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600,)),
                                    ),
                                    SizedBox(height: 10.h,),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ElevatedButton(
                                                  onPressed: (){
                                                    insertPurchaseTypeData(txtPurchaseType.text, context);
                                                    // insertShipmentData(txtShippingName.text, context);
                                                  }, 
                                                  style: ElevatedButton.styleFrom(
                                                    elevation: 0,
                                                    alignment: Alignment.centerLeft,
