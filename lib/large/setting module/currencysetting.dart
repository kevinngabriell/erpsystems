...
import 'package:erpsystems/large/setting%20module/addnewcurrency.dart';
...
class CurrencyIndexLarge extends StatefulWidget {
  const CurrencyIndexLarge({super.key});

  @override
  State<CurrencyIndexLarge> createState() => _CurrencyIndexLargeState();
}

class _CurrencyIndexLargeState extends State<CurrencyIndexLarge> {
  TextEditingController txtSearchText = TextEditingController();
  final storage = GetStorage();
  String profileName = '';
  String companyName = '';

  late Future<List<Map<String, dynamic>>> currencyList;
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add New Currency', style: TextStyle(fontSize: 4.sp),)
                                          )
                                        ],
                                      ),
                                    ),
                                              ...
                                              return DataTable(
                                                ...
                                                rows: snapshot.data!.asMap().entries.map<DataRow>((entry) {
                                                  ...
                                                  return DataRow(
                                                    cells: <DataCell>[
                                                      DataCell(Text('$index')),
                                                      DataCell(Text(currency['currency_name']))
                                                    ],
