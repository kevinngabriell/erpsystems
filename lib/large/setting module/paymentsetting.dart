...
class PaymentSettingLarge extends StatefulWidget {
  const PaymentSettingLarge({super.key});

  @override
  State<PaymentSettingLarge> createState() => _PaymentSettingLargeState();
}

class _PaymentSettingLargeState extends State<PaymentSettingLarge> {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add Payment Method', style: TextStyle(fontSize: 4.sp),)
                                          )
                                        ],
                                      ),
                                    ),
