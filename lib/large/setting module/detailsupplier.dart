...
class DetailSupplierSettingLarge extends StatefulWidget {
  final supplierId;
  DetailSupplierSettingLarge(this.supplierId);

  @override
  State<DetailSupplierSettingLarge> createState() => _DetailSupplierSettingLargeState();
}

class _DetailSupplierSettingLargeState extends State<DetailSupplierSettingLarge> {
  ...
  TextEditingController txtSupplierCountry = TextEditingController();
  TextEditingController txtSupplierFreeTrade = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Detail Supplier Configuration',
      home: Scaffold(
                                ...
                                child: FutureBuilder<Map<String, dynamic>>(
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState == ConnectionState.waiting) {
                                      ...
                                      SupplierData supplier = SupplierData.fromJson(data[0]);

                                      txtSupplierName.text = supplier.supplierName;
                                      txtSupplierPhone.text = supplier.supplierPhone;
                                      txtSupplierAddress.text = supplier.supplierAddress;
                                      txtSupplierPICName.text = supplier.supplierPICName;
                                      txtSupplierPICContact.text = supplier.supplierPICContact;
                                      // txtSupplierCountry.text = supplier.supplierOrigin;
                                      txtSupplierFreeTrade.text = convertToYesNo(supplier.freeTradeArea);
                                      selectedCountry = supplier.supplierOrigin;
                                      ...
                                      return Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text('Supplier Information', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600,)),
                                          ),
                                          SizedBox(height: 10.h,),
                                                ...
                                                children: [
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            TextFormField(
                                                              readOnly: true,
                                                              controller: txtSupplierFreeTrade,
                                                              decoration: InputDecoration(
                                                                enabledBorder: OutlineInputBorder(
                                                                  borderSide: const BorderSide(width: 0.0),
                                                                  borderRadius: BorderRadius.circular(10.0),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ElevatedButton(
                                                        onPressed: (){
                                                          updateSupplier(widget.supplierId, txtSupplierName.text, txtSupplierPhone.text, txtSupplierAddress.text, txtSupplierPICName.text, txtSupplierPICContact.text, selectedCountry, context);
                                                        }, 
                                                        style: ElevatedButton.styleFrom(
                                                          elevation: 0,
                                                          alignment: Alignment.centerLeft,
