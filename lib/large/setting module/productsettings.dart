...
import 'package:erpsystems/large/setting%20module/addnewproduct.dart';
...
class ProductSettingLarge extends StatefulWidget {
  const ProductSettingLarge({super.key});

  @override
  State<ProductSettingLarge> createState() => _ProductSettingLargeState();
}

class _ProductSettingLargeState extends State<ProductSettingLarge> {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            child: Text('Add New Product', style: TextStyle(fontSize: 4.sp),)
                                          )
                                        ],
                                      ),
                                    ),
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: DataTable(
                                          ...
                                          columns: const <DataColumn> [
                                            ...
                                            DataColumn(label: Text('SKU Number')),
