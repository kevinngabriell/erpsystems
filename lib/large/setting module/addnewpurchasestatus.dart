...
class AddNewPuchaseStatusLarge extends StatefulWidget {
  const AddNewPuchaseStatusLarge({super.key});

  @override
  State<AddNewPuchaseStatusLarge> createState() => _AddNewPuchaseStatusLargeState();
}

class _AddNewPuchaseStatusLargeState extends State<AddNewPuchaseStatusLarge> {
  TextEditingController txtSearchText = TextEditingController();
  final storage = GetStorage();
  String profileName = '';
  String companyName = '';

  TextEditingController txtPurchaseStatus = TextEditingController();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text('Add New Purchase Status', style: TextStyle(fontSize: 5.sp, fontWeight: FontWeight.w600,)),
                                    ),
                                    SizedBox(height: 10.h,),
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  child: Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      const Text('Purchase Status'),
                                                      SizedBox(height: 5.h,),
                                                      TextFormField(
                                                        controller: txtPurchaseStatus,
                                                        decoration: InputDecoration(
                                                          enabledBorder: OutlineInputBorder(
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ElevatedButton(
                                                  onPressed: (){
                                                    insertPurchaseStatusData(txtPurchaseStatus.text, context);
                                                  }, 
                                                  style: ElevatedButton.styleFrom(
                                                    elevation: 0,
                                                    alignment: Alignment.centerLeft,
